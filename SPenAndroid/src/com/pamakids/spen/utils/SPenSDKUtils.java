package com.pamakids.spen.utils;
...
public class SPenSDKUtils {
	...
	public static HashMap<String, Integer> getSettingLayoutLocaleResourceMap(boolean bUsePenSetting, boolean bUseEraserSetting, boolean bUseTextSetting, boolean bUseFillingSetting){
		...
		// Layout 
		if(bUsePenSetting){
			settingResourceMapInt.put(SCanvasConstants.LAYOUT_PEN_SPINNER, freContext.getResourceId("layout.mspinner"));
		}
		if(bUsePenSetting){
			settingResourceMapInt.put(SCanvasConstants.LOCALE_PEN_SETTING_TITLE, freContext.getResourceId("string.pen_settings"));
			settingResourceMapInt.put(SCanvasConstants.LOCALE_PEN_SETTING_PRESET_EMPTY_MESSAGE, freContext.getResourceId("string.pen_settings_preset_empty"));
			settingResourceMapInt.put(SCanvasConstants.LOCALE_PEN_SETTING_PRESET_DELETE_TITLE, freContext.getResourceId("string.pen_settings_preset_delete_title"));
			settingResourceMapInt.put(SCanvasConstants.LOCALE_PEN_SETTING_PRESET_DELETE_MESSAGE, freContext.getResourceId("string.pen_settings_preset_delete_msg"));
			settingResourceMapInt.put(SCanvasConstants.LOCALE_PEN_SETTING_PRESET_EXIST_MESSAGE, freContext.getResourceId("string.pen_settings_preset_exist"));
			settingResourceMapInt.put(SCanvasConstants.LOCALE_PEN_SETTING_PRESET_MAXIMUM_MESSAGE, freContext.getResourceId("string.pen_settings_preset_maximum_msg"));
		}
		if(bUseEraserSetting){
			settingResourceMapInt.put(SCanvasConstants.LOCALE_ERASER_SETTING_TITLE, freContext.getResourceId("string.eraser_settings"));
			settingResourceMapInt.put(SCanvasConstants.LOCALE_ERASER_SETTING_CLEARALL, freContext.getResourceId("string.clear_all"));
		}
		if(bUseFillingSetting){
			settingResourceMapInt.put(SCanvasConstants.LOCALE_FILLING_SETTING_TITLE, freContext.getResourceId("string.filling_settings"));
		}
		// common
		settingResourceMapInt.put(SCanvasConstants.LOCALE_SETTINGVIEW_CLOSE_DESCRIPTION, freContext.getResourceId("string.settingview_close_btn_desc"));
	...
	public static void alertActivityFinish(final Activity activity, String msg){
		...
		ad.setTitle(activity.getResources().getString(freContext.getResourceId("string.app_name")))
		.setMessage(msg)
